...
class Storage {
 public:
    ...
    Digest lookup_manifest(const oci::Reference& image);
    void store_image_name(DigestView manifest, const oci::Reference& image);

    std::vector<oci::Reference> list_images() const;
